...
|---|---|
| [`Firmware/ArduinoCode/`](Firmware/ArduinoCode/README.md) | Arduino Uno (default), Mega 2560, or Nano firmware — the transmission controller |
...
1. **Read [`Firmware/ArduinoCode/README.md`](Firmware/ArduinoCode/README.md)** — hardware requirements, wiring, and flash instructions
